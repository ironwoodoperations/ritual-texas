...
import AskWhitneyWidget from '@/components/AskWhitneyWidget';
          ...
          {isMenuOpen && (
            <div className="md:hidden absolute top-full left-0 right-0 bg-[rgb(248,246,242)] border-b border-[rgb(235,225,213)] py-6 px-6">
              <div className="flex flex-col gap-4">
                  ...
                  {isAdmin && (
                    <Link to={createPageUrl('AdminDashboard')} className="text-[rgb(107,85,64)] py-2 font-medium" onClick={() => setIsMenuOpen(false)}>
                      Admin Dashboard
                    </Link>
                  )}
                  <Link 
            ...
            <div className="grid md:grid-cols-4 gap-10">
              ...
              <div>
                ...
                <p className="text-sm text-[rgb(45,45,45)]">
                  <a 
                    href="https://www.google.com/maps/search/?api=1&query=540+El+Paso+Street+Jacksonville+Texas+75766" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="hover:text-[rgb(107,85,64)] transition-colors"
                  >
