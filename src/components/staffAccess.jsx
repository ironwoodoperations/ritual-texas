...
export const DEFAULT_MODULES = [
  ...
  },
  {
    ...
    defaultVisible: true,
    defaultRoles: 'chef,kitchen_staff,manager,general_manager',
  ...
  },
  {
    ...
    defaultVisible: true,
    defaultRoles: 'housekeeping,hotel_host,manager,general_manager',
  },
  {
    key: 'hotel',
    label: 'Hotel Reservations',
    defaultVisible: true,
    defaultRoles: 'hotel_host,manager,general_manager',
  },
  {
    key: 'spa_schedule',
    label: 'Spa Schedule',
    defaultVisible: true,
    defaultRoles: 'hotel_service_provider,manager,general_manager',
  },
  {
