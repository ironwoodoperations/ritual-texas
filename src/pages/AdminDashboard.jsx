        ...
        <div className="mb-4">
          ...
          <div className="grid grid-cols-6 gap-2">
            {[
              ...
              { name: 'SimplyBook', url: 'https://simplybook.me/en/admin', img: 'https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6952b5de56519adda6e982ce/ce2a541cc_download3.png', bg: '#ffffff' },
            ].map(({ name, url, img, bg }) => (
              <a
                key={name}
                href={url}
