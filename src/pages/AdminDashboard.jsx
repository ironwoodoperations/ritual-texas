        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-7 gap-2">
            {[
              ...
              { name: 'Lonam AI', url: 'https://loman.ai', img: 'https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6952b5de56519adda6e982ce/9202fdf0d_download.jpeg', bg: '#000000' },
