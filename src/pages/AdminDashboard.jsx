        ...
        <div className="mb-4">
          ...
          <div className="grid grid-cols-6 gap-2">
            {[
              ...
              { name: 'SimplyBook', url: 'https://simplybook.me/en/login', img: 'https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6952b5de56519adda6e982ce/9202fdf0d_download.jpeg', bg: '#000000' },
              { name: 'Sonos', url: 'https://www.sonos.com/account', img: 'https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6952b5de56519adda6e982ce/529bf1052_download2.png', bg: '#000000' },
              { name: 'Toast', url: 'https://www.toasttab.com/restaurants/admin', img: 'https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6952b5de56519adda6e982ce/17a611d1a_download1.png', bg: '#f5e642' },
              { name: 'Breezeway', url: 'https://app.breezeway.io/login', img: 'https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6952b5de56519adda6e982ce/d38672338_download.png', bg: '#f05a28' },
