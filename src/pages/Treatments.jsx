        ...
        <div style={{ display: 'grid', gap: '14px' }}>
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <a href="/booking?service=royal" target="_blank" rel="noopener noreferrer"
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <a href="/booking?service=aura" target="_blank" rel="noopener noreferrer"
                 style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 14px', borderRadius: '14px', fontWeight: 800, display: 'inline-block' }}>
                Book Now
              </a>
            </div>
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <div style={{ display: 'grid', gap: '10px', marginTop: '12px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', gap: '10px', alignItems: 'center', padding: '12px', borderRadius: '14px', background: 'rgba(240,232,221,.65)', border: '1px solid rgba(59,72,49,.08)' }}>
                <div style={{ fontWeight: 800, color: '#1B1B1B' }}>60 min</div>
                <a href="/booking?service=swedish60" target="_blank" rel="noopener noreferrer"
                   style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 14px', borderRadius: '14px', fontWeight: 800, display: 'inline-block' }}>
                  Book 60
                </a>
              </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', gap: '10px', alignItems: 'center', padding: '12px', borderRadius: '14px', background: 'rgba(240,232,221,.65)', border: '1px solid rgba(59,72,49,.08)' }}>
                ...
                <a href="/booking?service=swedish90" target="_blank" rel="noopener noreferrer"
                   style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 14px', borderRadius: '14px', fontWeight: 800, display: 'inline-block' }}>
                  Book 90
                </a>
              </div>
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ fontWeight: 800, color: '#1B1B1B' }}>90 min</div>
              <a href="/booking?service=lymphatic" target="_blank" rel="noopener noreferrer"
                 style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 14px', borderRadius: '14px', fontWeight: 800, display: 'inline-block' }}>
                Book Now
              </a>
            </div>
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <a href="/booking?service=shirodhara" target="_blank" rel="noopener noreferrer"
                 style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 14px', borderRadius: '14px', fontWeight: 800, display: 'inline-block' }}>
                Book Now
              </a>
            </div>
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ fontWeight: 800, color: '#1B1B1B' }}>120 min</div>
              <a href="/booking?service=shiroglow" target="_blank" rel="noopener noreferrer"
                 style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 14px', borderRadius: '14px', fontWeight: 800, display: 'inline-block' }}>
                Book Now
              </a>
            </div>
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ fontWeight: 800, color: '#1B1B1B' }}>1 hr</div>
              <a href="/booking?service=forgiveness" target="_blank" rel="noopener noreferrer"
                 style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 14px', borderRadius: '14px', fontWeight: 800, display: 'inline-block' }}>
                Book Now
              </a>
            </div>
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ fontWeight: 800, color: '#1B1B1B' }}>1 hr</div>
              <a href="/booking?service=reiki" target="_blank" rel="noopener noreferrer"
                 style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 14px', borderRadius: '14px', fontWeight: 800, display: 'inline-block' }}>
                Book Now
              </a>
            </div>
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <div style={{ display: 'grid', gap: '10px', marginTop: '12px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', gap: '10px', alignItems: 'center', padding: '12px', borderRadius: '14px', background: 'rgba(240,232,221,.65)', border: '1px solid rgba(59,72,49,.08)' }}>
                ...
                <a href="/booking?service=soundprivate" target="_blank" rel="noopener noreferrer"
                   style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 14px', borderRadius: '14px', fontWeight: 800, display: 'inline-block' }}>
                  Book Private
                </a>
              </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', gap: '10px', alignItems: 'center', padding: '12px', borderRadius: '14px', background: 'rgba(240,232,221,.65)', border: '1px solid rgba(59,72,49,.08)' }}>
                ...
                <a href="/booking?service=soundgroup" target="_blank" rel="noopener noreferrer"
                   style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 14px', borderRadius: '14px', fontWeight: 800, display: 'inline-block' }}>
                  Book Group
                </a>
              </div>
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <div style={{ display: 'grid', gap: '10px', marginTop: '12px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', gap: '10px', alignItems: 'center', padding: '12px', borderRadius: '14px', background: 'rgba(240,232,221,.65)', border: '1px solid rgba(59,72,49,.08)' }}>
                ...
                <a href="/booking?service=yogaprivate" target="_blank" rel="noopener noreferrer"
                   style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 14px', borderRadius: '14px', fontWeight: 800, display: 'inline-block' }}>
                  Book Private
                </a>
              </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', gap: '10px', alignItems: 'center', padding: '12px', borderRadius: '14px', background: 'rgba(240,232,221,.65)', border: '1px solid rgba(59,72,49,.08)' }}>
                <div style={{ fontWeight: 800, color: '#1B1B1B' }}>Group class</div>
                <a href="/booking?service=yogagroup" target="_blank" rel="noopener noreferrer"
                   style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 14px', borderRadius: '14px', fontWeight: 800, display: 'inline-block' }}>
                  Book Group
                </a>
              </div>
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <a href="/booking?service=drpark" target="_blank" rel="noopener noreferrer"
                 style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 14px', borderRadius: '14px', fontWeight: 800, display: 'inline-block' }}>
                Book Now
              </a>
            </div>
