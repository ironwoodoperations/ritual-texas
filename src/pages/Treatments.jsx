      ...
      <div style={{ maxWidth: '980px', margin: '0 auto' }}>
        <header style={{ marginBottom: '14px' }}>
          ...
          <p style={{ marginTop: '10px', color: '#1B1B1B', lineHeight: '1.65', maxWidth: '760px' }}>
            These are the only treatments currently available at Hotel RITUAL. Choose a ritual and book in minutes.
          </p>
        </header>

        <div style={{ display: 'grid', gap: '14px' }}>
          {/* 1 - The Royal Treatment Facial */}
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ fontWeight: 800, color: '#1B1B1B' }}>60 min · $198</div>
              <Link to={createPageUrl('TreatmentCheckout')} style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 12px', borderRadius: '14px', fontWeight: 800 }}>Book Now</Link>
            </div>
          </article>
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ fontWeight: 800, color: '#1B1B1B' }}>120 min · $250</div>
              <Link to={createPageUrl('TreatmentCheckout')} style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 12px', borderRadius: '14px', fontWeight: 800 }}>Book Now</Link>
            </div>
          </article>
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <div style={{ display: 'grid', gap: '8px', marginTop: '10px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', gap: '10px', padding: '10px 12px', borderRadius: '14px', background: 'rgba(240,232,221,.65)', border: '1px solid rgba(59,72,49,.08)' }}>
                <div style={{ fontWeight: 800, color: '#1B1B1B' }}>60 min</div>
                <div style={{ fontWeight: 900, color: '#1B1B1B' }}>$198</div>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', gap: '10px', padding: '10px 12px', borderRadius: '14px', background: 'rgba(240,232,221,.65)', border: '1px solid rgba(59,72,49,.08)' }}>
                <div style={{ fontWeight: 800, color: '#1B1B1B' }}>90 min</div>
                <div style={{ fontWeight: 900, color: '#1B1B1B' }}>$250</div>
              </div>
            </div>
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ fontWeight: 800, color: '#1B1B1B' }}>90 min · $298</div>
              <Link to={createPageUrl('TreatmentCheckout')} style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 12px', borderRadius: '14px', fontWeight: 800 }}>Book Now</Link>
            </div>
          </article>
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ fontWeight: 800, color: '#1B1B1B' }}>1 hr · $150</div>
              <Link to={createPageUrl('TreatmentCheckout')} style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 12px', borderRadius: '14px', fontWeight: 800 }}>Book Now</Link>
            </div>
          </article>
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ fontWeight: 800, color: '#1B1B1B' }}>1 hr · $75</div>
              <Link to={createPageUrl('TreatmentCheckout')} style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 12px', borderRadius: '14px', fontWeight: 800 }}>Book Now</Link>
            </div>
          </article>
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <p style={{ marginTop: '10px', color: '#1B1B1B', lineHeight: '1.65' }}>
              Holy Fire Reiki is a form of "hands-on-healing" in which your therapist works with universal life force energy to reset your energy centers (chakras) to their most natural state of flow. This treatment helps to restore and strengthen the mind, body, and spirit.
            </p>
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ fontWeight: 800, color: '#1B1B1B' }}>1 hr · $150</div>
              <Link to={createPageUrl('TreatmentCheckout')} style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 12px', borderRadius: '14px', fontWeight: 800 }}>Book Now</Link>
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <div style={{ display: 'grid', gap: '8px', marginTop: '10px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', gap: '10px', padding: '10px 12px', borderRadius: '14px', background: 'rgba(240,232,221,.65)', border: '1px solid rgba(59,72,49,.08)' }}>
                <div style={{ fontWeight: 800, color: '#1B1B1B' }}>Private 60 min session (up to 3 guests)</div>
                <div style={{ fontWeight: 900, color: '#1B1B1B' }}>$150</div>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', gap: '10px', padding: '10px 12px', borderRadius: '14px', background: 'rgba(240,232,221,.65)', border: '1px solid rgba(59,72,49,.08)' }}>
                <div style={{ fontWeight: 800, color: '#1B1B1B' }}>Group class every Friday (5:30–6:30)</div>
                <div style={{ fontWeight: 900, color: '#1B1B1B' }}>$20 per person</div>
              </div>
            </div>
            <div style={{ marginTop: '12px', display: 'flex', justifyContent: 'flex-end' }}>
              <Link to={createPageUrl('TreatmentCheckout')} style={{ textDecoration: 'none', background: '#C57C5D', color: '#FCF9F4', padding: '10px 12px', borderRadius: '14px', fontWeight: 800 }}>Book Now</Link>
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <p style={{ marginTop: '10px', color: '#1B1B1B', lineHeight: '1.65' }}>
              Yoga is a mix of gentle movements and breathing that helps you feel grounded, relaxed, and flexible while deeply detoxifying the lymphatic system and quieting the mind. This class is curated for you based on experience level and needs.
            </p>
            <div style={{ display: 'grid', gap: '8px', marginTop: '10px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', gap: '10px', padding: '10px 12px', borderRadius: '14px', background: 'rgba(240,232,221,.65)', border: '1px solid rgba(59,72,49,.08)' }}>
                <div style={{ fontWeight: 800, color: '#1B1B1B' }}>60 min Private class</div>
                <div style={{ fontWeight: 900, color: '#1B1B1B' }}>$60</div>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', gap: '10px', padding: '10px 12px', borderRadius: '14px', background: 'rgba(240,232,221,.65)', border: '1px solid rgba(59,72,49,.08)' }}>
                <div style={{ fontWeight: 800, color: '#1B1B1B' }}>60 min Group class (min. 5 people)</div>
                <div style={{ fontWeight: 900, color: '#1B1B1B' }}>$20 per person</div>
              </div>
            </div>
            <div style={{ marginTop: '12px', display: 'flex', justifyContent: 'flex-end' }}>
          ...
          <article style={{ background: '#FCF9F4', borderRadius: '18px', padding: '18px', boxShadow: '0 10px 30px rgba(0,0,0,.08)', border: '1px solid rgba(59,72,49,.10)' }}>
            ...
            <div style={{ display: 'grid', gap: '8px', marginTop: '10px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', gap: '10px', padding: '10px 12px', borderRadius: '14px', background: 'rgba(240,232,221,.65)', border: '1px solid rgba(59,72,49,.08)' }}>
                <div style={{ fontWeight: 800, color: '#1B1B1B' }}>15 minute session</div>
                <div style={{ fontWeight: 900, color: '#1B1B1B' }}>by donation</div>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', gap: '10px', padding: '10px 12px', borderRadius: '14px', background: 'rgba(240,232,221,.65)', border: '1px solid rgba(59,72,49,.08)' }}>
                <div style={{ fontWeight: 800, color: '#1B1B1B' }}>30 minute session</div>
                <div style={{ fontWeight: 900, color: '#1B1B1B' }}>by donation</div>
              </div>
            </div>
            <div style={{ marginTop: '12px', display: 'flex', justifyContent: 'flex-end' }}>
