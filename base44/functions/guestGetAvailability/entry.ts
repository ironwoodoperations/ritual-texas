...
// SimplyBook JSON-RPC auth then availability fetch — no admin auth required (guest-safe)
...
Deno.serve(async (req) => {
  ...
  // NO auth check — this function is intentionally callable by unauthenticated guests
  try {
